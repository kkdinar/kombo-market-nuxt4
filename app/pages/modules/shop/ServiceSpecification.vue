<template>
  ...
  <div align="center">
    <br>
    <h2>Справочник "Описание услуги"</h2>
    <br>
    <Tree :value="TreeEntity" selectionMode="checkbox" v-model:selectionKeys="ServiceSpecificationDocStore.selectedRows"
...
const getTree = async () => {
  const { mount, DocData } = ServiceSpecificationDocStore;
  await mount({
    module: 'shop',
...
onMounted(async () => {
  setToast(ServiceSpecificationDocStore.DocData, toast);
  setWatch(ServiceSpecificationDocStore.DocData, toast);
});
</script>
