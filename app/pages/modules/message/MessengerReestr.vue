<template>
  <div>
    <div class="fixed">
      <Toolbar>
        <template #start>
          <Button label="Назад" icon="pi pi-chevron-left" @click="clickBack({ module: 'message' })" />
          <p>|</p>
          <Button label="Создать группу" icon="pi pi-plus" class="p-button-success" @click="clickNewMessengerGroup" />
          <p>|</p>
          <Button label="Удалить группу" icon="pi pi-trash" class="p-button-danger"
