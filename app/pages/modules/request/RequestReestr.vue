<template>
  <div>
    <div class="fixed">
      <Toolbar>
        <template #start>
          <Button label="Назад" icon="pi pi-chevron-left" @click="clickBack({ module: 'request' })" />
          <p>|</p>
          <Button label="Создать" icon="pi pi-plus" class="p-button-success"
            @click="clickNew({ module: 'request', form: 'RequestDoc' })" />
          <p>|</p>
...
const DataStore = useDocHandlerStore('RequestDoc');
...
console.log('DataStore', unref(DataStore));
