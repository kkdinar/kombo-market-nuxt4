<template>
  <div class="products-page">
    ...
    <div>
      ...
      <table class="table">
        <tr>
          ...
          <td>
            <Button icon="pi pi-search" @click="filterFilteredCard" label="НАЙТИ" class="button-rounded" />
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            <Button label="ВОЙТИ" @click="enterSeller" class="button-rounded" /> {{ }}
            <Button label="КАТАЛОГ" @click="showCategories" class="button-rounded" /> {{ }}
            <Button label="ИЗБРАННОЕ" icon="pi pi-heart" @click="enterFavoriteDoc" class="button-rounded" />
            <Button label="Разместить объявление" icon="pi pi-pencil" @click="showCategories" class="button-rounded" />
          </td>
        </tr>
        <tr>
    ...
    <div class="item">
      <Button label="ТОВАРЫ" @click="enterShowFormProduct" class="button-rounded" /> {{ }}
      <Button label="УСЛУГИ" @click="enterShowFormService" class="button-rounded" />
    </div>
...
const creatingProductCard = (category: string) => {
  // console.log('selectedCategories=', unref(selectedCategories));
  //TODO: запрос на фильтрацию товаров
  console.log('filteredCategories=', category);
  visibleCategories.value = false;
